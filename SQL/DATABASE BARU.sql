...
-- Dumping database structure for app-pdmk
CREATE DATABASE IF NOT EXISTS `app-pdmk` /*!40100 DEFAULT CHARACTER SET utf32 COLLATE utf32_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `app-pdmk`;
...
-- Dumping data for table app-pdmk.merk: ~2 rows (approximately)
...
-- Dumping data for table app-pdmk.riwayat_transaksi_barang: ~19 rows (approximately)
...
-- Dumping data for table app-pdmk.satuan_barang: ~3 rows (approximately)
...
-- Dumping data for table app-pdmk.suplair: ~0 rows (approximately)
