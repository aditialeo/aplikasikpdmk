                ...
                <div class="card-body">
                    <form action="{{ route('jenisbarang.update', $jenisbarang->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" value="{{$jenisbarang->nama}}" class="form-control @error('nama') is-invalid @enderror" name="nama"
                        ...
                        <div class="form-group">
                            ...
                            <input name="keterangan" type="text" value="{{$jenisbarang->keterangan}}" class="form-control @error('keterangan') is-invalid @enderror" name="keterangan"
